...
//GEN-LINE:|4-resumeMIDlet|1|4-postAction
    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == form) {//GEN-BEGIN:|7-commandAction|1|19-preAction
            ...
            if (command == SplashScreen.DISMISS_COMMAND) {//GEN-END:|7-commandAction|3|24-preAction
                // write pre-action user code here
                switchDisplayable(null, getSplashScreen1());//GEN-LINE:|7-commandAction|4|24-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|5|26-preAction
        } else if (displayable == splashScreen1) {
            if (command == SplashScreen.DISMISS_COMMAND) {//GEN-END:|7-commandAction|5|26-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm());//GEN-LINE:|7-commandAction|6|26-postAction
                // write post-action user code here
    ...
    public SplashScreen getSplashScreen() {
        if (splashScreen == null) {//GEN-END:|22-getter|0|22-preInit
            ...
            splashScreen.setText("Duke: the Java mascot");//GEN-END:|22-getter|1|22-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: splashScreen1 ">//GEN-BEGIN:|25-getter|0|25-preInit
    /**
     * Returns an initiliazed instance of splashScreen1 component.
     * @return the initialized component instance
     */
    public SplashScreen getSplashScreen1() {
        if (splashScreen1 == null) {//GEN-END:|25-getter|0|25-preInit
            // write pre-init user code here
            splashScreen1 = new SplashScreen(getDisplay());//GEN-BEGIN:|25-getter|1|25-postInit
            splashScreen1.setTitle("splashScreen1");
            splashScreen1.setCommandListener(this);
            splashScreen1.setImage(getImage1());
            splashScreen1.setText("TA-DAAAA!!!");//GEN-END:|25-getter|1|25-postInit
            // write post-init user code here
    ...
    public Image getImage1() {
        if (image1 == null) {//GEN-END:|29-getter|0|29-preInit
            ...
            try {//GEN-BEGIN:|29-getter|1|29-@java.io.IOException
                image1 = Image.createImage("/226px-Wave.svg.png");
